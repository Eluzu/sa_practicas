...
def p_pro(op, x, p, c, t):
    ...
    if op == 1:
        ...
        # IVA condicional por categoría
        if t == "Tecnología":
            iva = p * 0.12 # IVA especifico para Tecnología
        else:
            iva = p * 0.15 # IVA general para otros productos
        total_con_iva = p + iva
        ...
        for l in lineas:
            ...
            categoria = datos2[3]
            # IVA condicional que hacemos de nuevo para el reporte
