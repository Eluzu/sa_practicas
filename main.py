...
def p_pro(op, codigo_barras, x, p, c, t):
    ...
    if op == 1:
        ...
        print("--------------------------------------------------")
        print("C_BARRAS | PROD | PRECIO | STOCK | CAT | PRECIO FINAL")
        print("--------------------------------------------------")
...
if __name__ == "__main__":
    ...
    p_pro(1, "7002551511609", "Laptop", 800.0, 5, "Tecnologia")
    p_pro(1, "7002550409805", "Cuaderno", 2.50, 50, "Utiles")
